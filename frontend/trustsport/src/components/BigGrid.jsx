        ...
        <>
            ...
            <div class="xl:container mx-auto px-3 sm:px-4 xl:px-2">
                ...
                <div class="flex-shrink max-w-full w-full lg:w-1/2 pb-1 lg:pb-0 lg:pr-1">
                    ...
                    <a href="#">
                        <img class="max-w-full w-full mx-auto h-auto" src={img1} alt="Image description"/>
                    </a>
                ...
                <div class="flex-shrink max-w-full w-full lg:w-1/2">
                    ...
                    <article class="flex-shrink max-w-full w-full sm:w-1/2">
                        ...
                        <a href="#">
                            <img class="max-w-full w-full mx-auto h-auto" src={img2} alt="Image description"/>
                        </a>
                    ...
                    <article class="flex-shrink max-w-full w-full sm:w-1/2">
                        <div class="relative hover-img max-h-48 overflow-hidden">
                        <a href="#">
                            <img class="max-w-full w-full mx-auto h-auto" src={img3} alt="Image description"/>
                        </a>
                        <div class="absolute px-4 pt-7 pb-4 bottom-0 w-full bg-gradient-cover">
                            <a href="#">
                    ...
                    <article class="flex-shrink max-w-full w-full sm:w-1/2">
                        <div class="relative hover-img max-h-48 overflow-hidden">
                        <a href="#">
                            <img class="max-w-full w-full mx-auto h-auto" src={img4} alt="Image description"/>
                        </a>
                        <div class="absolute px-4 pt-7 pb-4 bottom-0 w-full bg-gradient-cover">
                            <a href="#">
                    ...
                    <article class="flex-shrink max-w-full w-full sm:w-1/2">
                        <div class="relative hover-img max-h-48 overflow-hidden">
                        <a href="#">
                            <img class="max-w-full w-full mx-auto h-auto" src={img5} alt="Image description"/>
                        </a>
                        <div class="absolute px-4 pt-7 pb-4 bottom-0 w-full bg-gradient-cover">
                            <a href="#">
